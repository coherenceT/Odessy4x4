...
categories = [
    ...
    },
    {
        ...
        "title": "Adventure Roll Bars",
        "subtitle": "Rugged and functional Odyssey roll bars designed to secure gear and add structural integrity to your load bed."
    },
    {
        "id": "winches",
        "filename": "category-winches.html",
        "title": "Recovery Winches",
        "subtitle": "Heavy-duty electric recovery winches engineered for extreme extraction, featuring wireless remotes and synthetic ropes."
    },
    {
        "id": "snorkels",
        "filename": "category-snorkels.html",
        "title": "Raised Air Intakes & Snorkels",
        "subtitle": "Raised air intakes designed to deliver clean, cool air to your engine, protecting it from dust and deep water crossings."
    },
    {
        "id": "suspensions",
        "filename": "category-suspensions.html",
        "title": "Suspension Systems",
        "subtitle": "High-performance heavy-duty shocks and leaf spring packages built to enhance offroad control and load capacity."
    },
    {
        "id": "lighting",
        "filename": "category-lighting.html",
        "title": "Strands Lighting",
        "subtitle": "Illuminate dark trails with Odyssey premium Strands LED light bars, driving spotlights, and amber backlights."
    },
    {
        "id": "battery",
        "filename": "category-battery.html",
        "title": "Battery Systems",
        "subtitle": "Smart in-vehicle dual battery split charging systems and power hubs to run your overland fridge and camp setup."
    }
]
    ...
    <div class="top-bar">
        <div class="container">
            <div class="top-bar-contact">
                <a href="tel:+27722573089"><i class="fas fa-phone"></i> +27 72 257 3089</a>
                <a href="mailto:info@odyssey4x4.co.za"><i class="fas fa-envelope"></i> info@odyssey4x4.co.za</a>
            </div>
            <div class="top-bar-social">
                <a href="#" target="_blank"><i class="fab fa-facebook-f"></i></a>
                <a href="#" target="_blank"><i class="fab fa-instagram"></i></a>
                <a href="https://wa.me/27722573089" target="_blank"><i class="fab fa-whatsapp"></i></a>
            </div>
        </div>
    </div>
        ...
        <div class="main-header">
            <div class="container main-header-content">
                ...
                <a href="index.html" class="header-logo">
                    <img src="assets/images/odyssey4x4-logo-dark.svg" alt="Odyssey 4x4 Logo">
                </a>
                    ...
                    <ul>
                        ...
                        <li class="has-dropdown">
                            ...
                            <ul class="dropdown">
                                ...
                                <li><a href="category-winches.html">Winches</a></li>
                                <li><a href="category-snorkels.html">Snorkels</a></li>
                                <li><a href="category-suspensions.html">Suspensions</a></li>
                                <li><a href="category-lighting.html">Strands Lighting</a></li>
                                <li><a href="category-battery.html">Battery Systems</a></li>
                            </ul>
                        </li>
                        <li class="has-dropdown">
    ...
    <div class="slide-menu" id="slide-menu">
        ...
        <div class="slide-menu-links">
            ...
            <div class="mobile-accordion">
                ...
                <div class="accordion-content">
                    <a href="category-winches.html"><i class="fas fa-chevron-right"></i> Winches</a>
                    <a href="category-snorkels.html"><i class="fas fa-chevron-right"></i> Snorkels</a>
                    <a href="category-drawer-systems.html"><i class="fas fa-chevron-right"></i> DECKED Drawer System</a>
                    <a href="category-suspensions.html"><i class="fas fa-chevron-right"></i> Suspensions</a>
                    <a href="category-lighting.html"><i class="fas fa-chevron-right"></i> Strands Lighting</a>
                    <a href="category-battery.html"><i class="fas fa-chevron-right"></i> Dual Battery Systems</a>
                </div>
            </div>
            ...
            <div class="menu-promo-container">
                ...
                <!-- Banner 2: Lighting Systems -->
                <a href="https://wa.me/27722573089?text=Hi%20Odyssey%204x4%2C%20I%20would%20like%20to%20inquire%20about%20Lighting%20Systems." target="_blank" class="menu-promo-card promo-lighting">
                    <span class="promo-badge">FEEL THE PASSION</span>
                    <h4>Shop Lighting Systems</h4>
            ...
            <div class="mobile-accordion">
                <button class="accordion-toggle"><i class="fas fa-toolbox"></i> Shop Accessories & Drawers <i class="fas fa-chevron-down"></i></button>
                <div class="accordion-content">
                    <a href="category-front-bumpers.html"><i class="fas fa-chevron-right"></i> Evolution Front Bumpers</a>
                    <a href="category-rear-bumpers.html"><i class="fas fa-chevron-right"></i> Evolution Rear Bumpers</a>
                    <a href="category-rock-sliders.html"><i class="fas fa-chevron-right"></i> Rock Sliders</a>
                    <a href="category-accessories.html"><i class="fas fa-chevron-right"></i> Adventure roll Bar</a>
                    <a href="category-lighting.html"><i class="fas fa-chevron-right"></i> Strands Lighting</a>
                </div>
            </div>
